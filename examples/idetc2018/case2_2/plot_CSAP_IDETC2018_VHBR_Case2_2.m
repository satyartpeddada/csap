%--------------------------------------------------------------------------
% plot_CSAP_IDETC2018_VHBR_Case2_2.m
% 
%--------------------------------------------------------------------------
%
%--------------------------------------------------------------------------
...
fheight = 340; % figure height in pixels
...
plot(x(find(B==3824)),y(find(B==3824)),'.','linewidth',1,'color','k','markersize',6); hold on
...
if ymax >= p.xmax(5)
    text(0.02*(max(t)-min(t)),p.xmax(5),'1','interpreter','latex',...
...
% add the tree
% ax1 = axes('Position',[0.67 0.0 0.3 0.20]);
% ax1.Visible='off';
